...
namespace PaintIn3D
{
	...
	public class P3dPaintDecal : MonoBehaviour, IHit, IHitPoint, IHitLine, IHitQuad, IHitRaycast
	{
		...
		/// NOTE: UV painting only works with components that perform raycasts against non-convex <b>MeshColliders</b> (e.g. <b>P3dHitScreen</b>, <b>P3dHitBetween</b>).</summary>
		...
		private Vector3 HandleHitCommon(bool preview, float pressure, int seed, Quaternion rotation)
		{
			...
			P3dCommandDecal.Instance.SetMaterial(blendMode, finalTexture, shape, shapeChannel, finalHardness, wrapping, normalBack, normalFront, normalFade, finalColor, finalOpacity, tileTexture, finalMatrix, tileOpacity);
